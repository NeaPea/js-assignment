...
// Opgave js201.js - Changes have been made - Not optimal
/*'use strict';
let leapYear = Number(prompt("Write in todays year, to see if it is a leap year:"));
console.log(leapYear%4===0); console.log(leapYear % 4 == 0 && !(leapYear % 100 == 00)) || leapYear % 400 == 00;*/
'use strict';
